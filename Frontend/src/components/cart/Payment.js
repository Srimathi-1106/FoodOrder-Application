...
import {
    ...
    CardExpiryElement,
    CardCvcElement,
} from "@stripe/react-stripe-js";  //importing stripe elemts to handle card payment
...
const Payment = () => {
    ...
    if(result.error){
        ...
        if(result.paymentIntent.status==="succeeded"){
            ...
            alert.error("There is some issue ehile payment processing");
        }
    }
    }
    catch(error){
    ...
    <>
      ...
      <div className="row wrapper">
        <div className="col-10 col-lg-5">
            <form className="loginme shadow-lg" onSubmit={submitHandler}>
                ...
                <button id="pay_btn" type="submit" className="btn btn-block py3">
